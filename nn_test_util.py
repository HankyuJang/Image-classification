...
def test_NN(alpha, iterations, lambd, hidden_layers, REDUCE_DIM=False):
    ...
    result = ("Test", str(test_score)+"%", "train", str(train_score)+"%", "log loss", nnet.costs[-1][-1],
              "alpha", alpha, "iterations", iterations, "lambd", lambd, "layers",
